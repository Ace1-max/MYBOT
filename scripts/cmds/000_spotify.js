...
module.exports = {
    ...
    try {
        ...
        api.sendMessage("🔎 Searching for the track, please wait...", event.threadID, async (err) => {
            ...
            try {
                ...
                api.sendMessage("❌ An error occurred while fetching the track. Please try again later.", event.threadID);
            }
        });
  ...
  downloadAndSendTrack: async function (api, event, downloadUrl, trackName) {
    try {
        ...
        api.sendMessage("❌ Failed to download the track. Please try again.", event.threadID);
    }
  },
